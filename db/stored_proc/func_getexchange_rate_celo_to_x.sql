...
ALTER FUNCTION public.func_getexchange_rate_celo_to_x(varchar,numeric) OWNER TO u5p3hgrt8h7nt4;
GRANT ALL ON FUNCTION public.func_getexchange_rate_celo_to_x(varchar,numeric) TO public;
GRANT ALL ON FUNCTION public.func_getexchange_rate_celo_to_x(varchar,numeric) TO u5p3hgrt8h7nt4;
